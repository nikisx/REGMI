...
const BOARD_MEMBERS: BoardMember[] = [
  { name: 'Проф. д-р Албена Златарева, д.м.', role: 'Председател', title: 'Експерт по регулация' },
  { name: 'Доц. д-р Иван Малкодански, д.м.', role: 'Член на УС', title: 'Медицински специалист' },
